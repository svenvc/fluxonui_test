defmodule FluxonUITestWeb.TodoLiveTest do
  use FluxonUITestWeb.ConnCase

  import Phoenix.LiveViewTest
  import FluxonUITest.TodosFixtures

  @create_attrs %{description: "some description", due: "2025-09-25"}
  @update_attrs %{description: "some updated description", due: "2025-09-26"}
